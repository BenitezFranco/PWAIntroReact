  ...
  return (
    <div>
      ...
      <div className="container mx-auto px-4 py-8">
        <h2 className="uppercase text-3xl text-orange-700 font-sans mb-4">
          {receta.titulo}
        </h2>
        ...
        <IterarLista
          json={receta}
          arreglo="instrucciones"
          tipo="list-decimal"
        />

        <div style={{ marginBottom: "20px", textAlign: "center" }}>
          <PDFDownloadLink
            document={<Pdf receta={receta} />}
            fileName={`${receta.titulo}.pdf`}
          >
            {({ loading }) => <BotonPdf parametro={loading} />}
          </PDFDownloadLink>
        </div>
      </div>
      <Footer />
